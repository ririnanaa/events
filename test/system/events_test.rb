...
class EventsTest < ApplicationSystemTestCase
  ...
  test "/events/new ページを表示" do
    ...
    visit new_event_url
    assert_selector "h1", test: "イベント作成"
  end
  ...
  test "/events/new ページでフォームへ記入して登録" do
    ...
    select I18n.I(start_at, format: '%B'), from: "#{start_at_field}_2i" #月
    ...
    select I18n.I(end_at, format: '%B'), from: "#{end_at_field}_2i" #月
  ...
  test "/events/:id ページを表示して削除ボタンを押す" do
    ...
    assert_difference("Event.count", -1) do
      ...
      assert_selector "div.alert", text: "削除"
    end
  end
end
